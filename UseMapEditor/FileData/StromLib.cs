...
namespace UseMapEditor.FileData
{
    public class StromLib
    {
        ...
        public const uint HASH_TABLE_SIZE_MIN = 0x4;
        public const uint HASH_TABLE_SIZE_DEFAULT = 0x1000;
        public const uint HASH_TABLE_SIZE_MAX = 0x80000;
        public const uint HASH_ENTRY_DELETED = 0xFFFFFFFEU;
        public const uint HASH_ENTRY_FREE = 0xFFFFFFFFU;
        public const uint HET_ENTRY_DELETED = 0x80;
        public const uint HET_ENTRY_FREE = 0x0;
        ...
        public const uint SFILE_OPEN_FROM_MPQ = 0x0;
        public const uint SFILE_OPEN_BASE_FILE = 0xFFFFFFFDU;
        public const uint SFILE_OPEN_ANY_LANG = 0xFFFFFFFEU;
        public const uint SFILE_OPEN_LOCAL_FILE = 0xFFFFFFFFU;

        public const uint SFILE_INVALID_SIZE = 0xFFFFFFFFU;
        public const uint SFILE_INVALID_POS = 0xFFFFFFFFU;
        public const uint SFILE_INVALID_ATTRIBUTES = 0xFFFFFFFFU;
        ...
        public const uint SFILE_VERIFY_SECTOR_CRC = 0x1;
        public const uint SFILE_VERIFY_FILE_CRC = 0x2;
        public const uint SFILE_VERIFY_FILE_MD5 = 0x4;
        public const uint SFILE_VERIFY_RAW_MD5 = 0x8;
        public const uint SFILE_VERIFY_ALL = 0xF;
        public const uint SFILE_VERIFY_MPQ_HEADER = 0x1;
        public const uint SFILE_VERIFY_HET_TABLE = 0x2;
        public const uint SFILE_VERIFY_BET_TABLE = 0x3;
        public const uint SFILE_VERIFY_HASH_TABLE = 0x4;
        public const uint SFILE_VERIFY_BLOCK_TABLE = 0x5;
        public const uint SFILE_VERIFY_HIBLOCK_TABLE = 0x6;
        public const uint SFILE_VERIFY_FILE = 0x7;

        public const uint MPQ_PATCH_PREFIX_LEN = 0x20;

        public const uint MPQ_FLAG_READ_ONLY = 0x1;
        public const uint MPQ_FLAG_CHANGED = 0x2;
        public const uint MPQ_FLAG_PROTECTED = 0x4;
        public const uint MPQ_FLAG_CHECK_SECTOR_CRC = 0x8;
        public const uint MPQ_FLAG_NEED_FIX_SIZE = 0x10;
        public const uint MPQ_FLAG_INV_LISTFILE = 0x20;
        public const uint MPQ_FLAG_INV_ATTRIBUTES = 0x40;

        public const uint MPQ_FILE_IMPLODE = 0x100;
        public const uint MPQ_FILE_COMPRESS = 0x200;
        public const uint MPQ_FILE_COMPRESSED = 0xFF00;
        public const uint MPQ_FILE_ENCRYPTED = 0x10000;
        public const uint MPQ_FILE_FIX_KEY = 0x20000;
        public const uint MPQ_FILE_PATCH_FILE = 0x100000;
        public const uint MPQ_FILE_SINGLE_UNIT = 0x1000000;
        public const uint MPQ_FILE_DELETE_MARKER = 0x2000000;
        public const uint MPQ_FILE_SECTOR_CRC = 0x4000000;
        public const uint MPQ_FILE_EXISTS = 0x80000000U;
        public const uint MPQ_FILE_REPLACEEXISTING = 0x80000000U;

        public const uint MPQ_COMPRESSION_HUFFMANN = 0x1;
        public const uint MPQ_COMPRESSION_ZLIB = 0x2;
        public const uint MPQ_COMPRESSION_PKWARE = 0x8;
        ...
        public const uint MPQ_COMPRESSION_NEXT_SAME = 0xFFFFFFFFU;
        ...
        public const uint MPQ_KEY_HASH_TABLE = 0xC3AF3770U;
        public const uint MPQ_KEY_BLOCK_TABLE = 0xEC83B3A3U;
        ...
        public const uint MPQ_ATTRIBUTE_CRC32 = 0x1;
        public const uint MPQ_ATTRIBUTE_FILETIME = 0x2;
        public const uint MPQ_ATTRIBUTE_MD5 = 0x4;
        public const uint MPQ_ATTRIBUTE_PATCH_BIT = 0x8;
        public const uint MPQ_ATTRIBUTE_ALL = 0xF;
        public const uint MPQ_ATTRIBUTES_V1 = 100;

        public const uint BASE_PROVIDER_FILE = 0x0;
        public const uint BASE_PROVIDER_MAP = 0x1;
        public const uint BASE_PROVIDER_HTTP = 0x2;
        public const uint BASE_PROVIDER_MASK = 0xF;

        public const uint STREAM_PROVIDER_LINEAR = 0x0;
        public const uint STREAM_PROVIDER_PARTIAL = 0x10;
        public const uint STREAM_PROVIDER_ENCRYPTED = 0x20;
        public const uint STREAM_PROVIDER_MASK = 0xF0;
        public const uint STREAM_FLAG_READ_ONLY = 0x100;
        public const uint STREAM_FLAG_WRITE_SHARE = 0x200;
        public const uint STREAM_FLAG_MASK = 0xFF00;
        public const uint STREAM_OPTIONS_MASK = 0xFFFF;

        public const uint MPQ_OPEN_NO_LISTFILE = 0x10000;
        public const uint MPQ_OPEN_NO_ATTRIBUTES = 0x20000;
        public const uint MPQ_OPEN_FORCE_MPQ_V1 = 0x40000;
        public const uint MPQ_OPEN_CHECK_SECTOR_CRC = 0x80000;
        public const uint MPQ_OPEN_READ_ONLY = STREAM_FLAG_READ_ONLY;
        public const uint MPQ_OPEN_ENCRYPTED = STREAM_PROVIDER_ENCRYPTED;

        public const uint MPQ_CREATE_ATTRIBUTES = 0x100000;
        public const uint MPQ_CREATE_ARCHIVE_V1 = 0x0;
        public const uint MPQ_CREATE_ARCHIVE_V2 = 0x1000000;
        public const uint MPQ_CREATE_ARCHIVE_V3 = 0x2000000;
        public const uint MPQ_CREATE_ARCHIVE_V4 = 0x3000000;
        public const uint MPQ_CREATE_ARCHIVE_VMASK = 0xF000000;

        public const uint MPQ_HEADER_SIZE_V1 = 0x20;
        public const uint MPQ_HEADER_SIZE_V2 = 0x2;
        ...
        public const uint VERIFY_OPEN_ERROR = 0x1;
        public const uint VERIFY_READ_ERROR = 0x2;

        public const uint VERIFY_FILE_HAS_SECTOR_CRC = 0x4;
        public const uint VERIFY_FILE_SECTOR_CRC_ERROR = 0x8;
        public const uint VERIFY_FILE_HAS_CHECKSUM = 0x10;
        public const uint VERIFY_FILE_CHECKSUM_ERROR = 0x20;
        public const uint VERIFY_FILE_HAS_MD5 = 0x40;
        public const uint VERIFY_FILE_MD5_ERROR = 0x80;
        public const uint VERIFY_FILE_HAS_RAW_MD5 = 0x100;
        public const uint VERIFY_FILE_RAW_MD5_ERROR = 0x200;
        ...
        public const uint LANG_FRENCH = 0x40;
        ...
        public const uint SIZE_OF_XFRM_HEADER = 0xC;
