...
flag1 = {__trg_magic="trgconst"}
preserved = {__trg_magic="trgconst"}
disabled = {__trg_magic="trgconst"}
flag4 = {__trg_magic="trgconst"}
flag5 = {__trg_magic="trgconst"}
flag6 = {__trg_magic="trgconst"}
...
function EncodeTrigFlag(s)
    return EncodeConst(TrigFlagDict, s)
end
