...
namespace UseMapEditor.MonoGameControl
{
    public class CustomWpfMouse
    {
        ...
        public CustomWpfMouse(UIElement focusElement)
        {
        ...
        private void HandleMouse(object sender, MouseEventArgs e)
        {
            ...
            if (!_focusElement.IsMouseDirectlyOver || _focusElement.IsMouseCaptured)
            {
                ...
                if (_focusElement.IsMouseCaptured)
                {
                    ...
                    else
                    {
                        ...
                        _mouseState = new MouseState((int)pos.X, (int)pos.Y, _mouseState.ScrollWheelValue + ((e as MouseWheelEventArgs)?.Delta ?? 0), (ButtonState)e.LeftButton, (ButtonState)e.MiddleButton, (ButtonState)e.RightButton, (ButtonState)e.XButton1, (ButtonState)e.XButton2);
            ...
            _mouseState = new MouseState((int)pos.X, (int)pos.Y, m.ScrollWheelValue + ((e as MouseWheelEventArgs)?.Delta ?? 0), (ButtonState)e.LeftButton, (ButtonState)e.MiddleButton, (ButtonState)e.RightButton, (ButtonState)e.XButton1, (ButtonState)e.XButton2);
